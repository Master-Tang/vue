<template>
  <div class="my-padding">
    ...
    <el-divider content-position="center">财产线索</el-divider>
      ...
      <el-form :model="form">
        ...
        <el-row style="padding-bottom: 1rem">
          ...
          <el-col :span="12">
            <span>可回收金额(元):</span>
            <el-input
              v-model="form.recycleMoney"
              style="width: 52.5%"
              oninput="if(isNaN(value)) { value = null } if(value.indexOf('.')>0){value=value.slice(0,value.indexOf('.')+3)}"
              placeholder="请输入可回收金额"
            ></el-input>
          </el-col>
        </el-row>
        <el-row style="padding-bottom: 1rem">
    ...
    <el-table :data="proinfoList" border show-summary style="width: 100% ;padding-top: 2rem;">
      <el-table-column prop="a" label="序号" align="center" width="50rem"></el-table-column>
      <el-table-column prop="assetOwner" align="center" label="资产所有人"></el-table-column>
      <el-table-column prop="assetType" align="center" label="资产类型"></el-table-column>
      <el-table-column prop="assetDescript" align="center" label="财产线索描述"></el-table-column>
      <el-table-column prop="recycleMoney" sortable align="center" label="可回收金额(元)"></el-table-column>
      <el-table-column prop="basis" align="center" label="依据"></el-table-column>
      <el-table-column prop="borrowRelate" align="center" label="与借款人关系"></el-table-column>
      <el-table-column align="center" label="操作">
        <template slot-scope="scope">
          <el-button
            ...
            icon="el-icon-edit"
            circle
            @click="changeproinfo(scope.row.clueId)"
          ></el-button>
          <el-button
            type="danger"
            size="small"
            icon="el-icon-delete"
            circle
            @click="deleteproinfo(scope.row.clueId)"
          ></el-button>
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    fetchData() {
      $.assetClueList({ claimsNumber: this.$route.query.claimsNumber }).then(
        (res) => {
