<template>
  <el-form ref="form" :model="form" label-width="5rem">
    <el-form-item>
      <span slot="label">对应借款合同<span class="red">*</span></span>
    ...
    <el-form-item>
      <span slot="label">保证人金额<span class="red">*</span></span>
      <el-input v-model="form.guarantorAmount" type="text" placeholder="请输入保证人金额"></el-input>
    </el-form-item>
    <el-form-item>
      <span slot="label">保证合同编号<span class="red">*</span></span>
    ...
    <el-form-item>
      <span slot="label">保证人名称<span class="red">*</span></span>
      ...
      <el-tab-pane label="自然人" name="first" v-if="form.guarantorType=='01'">
        <el-form ref="form" :model="form" label-width="5rem">
          ...
          <el-form-item>
            ...
            <el-input v-model="form.naturalContact" type="text" placeholder="请输入联系方式"></el-input>
          </el-form-item>
        </el-form>
      </el-tab-pane>
      <el-tab-pane label="法人" name="first" v-if="form.guarantorType=='02'">
        <el-form ref="form" :model="form" label-width="5rem">
          ...
          <el-form-item>
            ...
            <el-input v-model="form.corporateMoney" type="text" placeholder="请输入注册资金"></el-input>
          </el-form-item>
        </el-form>
      </el-tab-pane>
    </el-tabs>
    <el-form-item>
      ...
      <el-select v-model="form.guarantee" placeholder="请选择关系" style="width:100%">
        <el-option
    ...
    <el-form-item>
      <el-button type="primary" @click="addguarantee">保存</el-button>
      <el-button type="warning" @click="updateguarantee">更改</el-button>
    </el-form-item>
  </el-form>
</template>
<script>
